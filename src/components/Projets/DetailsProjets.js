...
const DetailsProjets = () =>{
    ...
    const submitHandler = async(e) => {
        ...
        console.log(projetDetails.admin);
        if(projetDetails.admin === true){
            ...
            projetDetails.membres.map((membre)=>{
                const postsMembreRef = doc(db, "membres", membre.id, "projets", params.projetId, "chat", Post.id);
                ...
                projetDetails.membres.map((membre)=>{
                    const postsMembreRef = collection(db, "membres", membre.id, "projets", params.projetId, "chat");
                    const postsAdded = addDoc(postsMembreRef, {
                        auteur: ctx.user.displayName,
                        texte: posts
                    }, { merge: true });

                    const postRef = doc(db, "membres", projetDetails.adminID, "projets", params.projetId, "chat", postsAdded.id);
